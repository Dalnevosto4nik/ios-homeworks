...
class LogInViewController: UIViewController {
    ...
    private lazy var userLoginTextField: UITextField = {
        ...
        // userLoginTextField.layer.borderWidth = 0.5 // Задаем в stackView
        // userLoginTextField.layer.borderColor = UIColor.lightGray.cgColor // Задаем в stackView
    ...
    private lazy var userPasswordTextField: UITextField = {
        ...
        // userPasswordTextField.layer.borderWidth = 0.5 // Задаем в stackView
        // userPasswordTextField.layer.borderColor = UIColor.lightGray.cgColor // Задаем в stackView
